...
public class Soups extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //HttpGet httpget = new HttpGet("http://192.168.11.3/lab/soups.json");
		HttpGet httpget = new HttpGet("http://192.168.11.3/lab/soups.json");
	...
	private class homeListener  implements OnClickListener {
		...
		public void onClick(View arg0) {
			...
			Toast.makeText(getApplicationContext(), "Home Screen Loading...", Toast.LENGTH_LONG).show();
			homeit.putExtras(g);
    ...
    private class orderListener  implements OnClickListener {
		...
		public void onClick(View arg0) {
			...
			Toast.makeText(getApplicationContext(), "Loading your current Order...", Toast.LENGTH_LONG).show();
			orderit.putExtras(g);
    ...
    private class helpListener  implements OnClickListener {
		...
		public void onClick(View arg0) {
			...
			Toast.makeText(getApplicationContext(), "Loading Help Screen...", Toast.LENGTH_LONG).show();
			helpit.putExtras(g);
